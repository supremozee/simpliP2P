...
export const ORGANIZATION_ENDPOINTS = {
  ...
  DEACTIVATE_CATEGORY: (orgId: string, categoryId: string) => `${BASE_URL}/organisations/${orgId}/categories/${categoryId}/deactivate`,
  REACTIVATE_CATEGORY: (orgId: string, categoryId: string) => `${BASE_URL}/organisations/${orgId}/categories/${categoryId}/reactivate`,
