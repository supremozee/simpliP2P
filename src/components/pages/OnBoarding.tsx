        ...
        {isLargeScreen ? (
          <>
            ...
            <motion.div
              ...
              className='flex flex-col gap-8 w-[964px] mt-5'
            >
              ...
              width='book' fontSize='12px' className='flex justify-center items-center py-2'> Let&apos;s go</Button>
              <div className='flex z-10 mt-[187px] gap-10 ml-14'>
                {steps.map((step, idx) => (
                  <motion.div
                    ...
                    className='flex w-full gap-5 flex-col relative'
                  >
          ...
          <div className='min-h-screen flex-col flex justify-center items-center w-full mt-[10rem] mb-[2rem]'>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className='flex flex-col gap-5 items-center w-full justify-center font-roboto'
            >
              ...
              <Button
                onClick={() => router.push('/login')}
                width='book' radius='full' kind='tertiary' fontSize='12px'
              >
                <span className='text-[#2D2D2D] text-[15px] flex justify-center items-center gap-2'>
                  Let&apos;s go<MdKeyboardArrowRight size={13} className='font-bold' />
                </span>
              </Button>
              <div className='flex flex-col z-10 gap-10'>
                {steps.map((step, idx) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: idx * 0.2 }}
                    className='flex w-full flex-col relative bg-white justify-center items-center rounded-lg px-12 py-5 gap-4'
                  >
