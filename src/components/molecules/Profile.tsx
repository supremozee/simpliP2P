...
const Profile = () => {
  ...
  const currentOrgDetails = organizationDetails.find(
      ...
      >
        ...
        <Image
          src={
            ...
            "/c0749b7cc401421662ae901ec8f9f660.jpg"
          }
          alt="Profile pic"
          width={60}
          height={60}
          ...
          >
            ...
            <div className="px-4 py-2 border-b border-gray-100">
              ...
              >
                ...
                <span className="text-sm #181819">Change Profile Picture</span>
              </button>
            </div>
            <div className="px-4 py-2 border-b border-gray-100">
              <Button
