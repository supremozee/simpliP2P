...
const MobileHeader = forwardRef<HTMLElement, MobileHeaderProps>(({collapsed, isOpen, toggleSidebar}, ref)=> {
   ...
   return (
    collapsed && !isOpen&&( <header className='flex w-full bg-[#808080] bg-opacity-15 fixed top-0 font-roboto justify-between items-center px-5 py-2 z-50 cursor-pointer' ref={ref}>
