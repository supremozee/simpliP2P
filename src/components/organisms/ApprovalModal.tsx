...
const ApprovalModal = ({ pr_id }: { pr_id: string }) => {
  ...
  const { data, isLoading, isError } = useFetchPurchaseRequisitionById(
    currentOrg,
    pr_id
  );
  const { data: budgets, isLoading: isBudgetLoading } =
    useFetchBudget(currentOrg);
      ...
      >
        <div className="p-6 text-center">
          <div className="text-red-500 mb-2">
            Error fetching requisition details
          </div>
  ...
  const handleApprove = async () => {
    ...
    await updateRequisitionStatus(currentOrg, pr_id, {
      status: "APPROVED",
      approval_justification: requisition?.justification || "",
    ...
    <>
      {isRejectModalOpen && (
        <ConfirmReject
          ...
          requisition={{
            id: pr_id,
            name: requisition?.request_description || "this requisition",
          }}
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">
                      {requisition?.requestor_phone}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Email</p>
                    <p className="text-sm font-medium">
                      {requisition?.requestor_email}
                    </p>
                  </div>
                  <div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    ...
                    ) : selectedActionType === "approve_and_create_po" ? (
                      "Approve & Create PO"
                    ) : (
                      "Approve Requisition"
                    )}
        ...
        >
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Are you sure you want to approve this purchase requisition? This
