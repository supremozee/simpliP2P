  ...
  return (
    <div className='flex flex-col font-roboto'>
      <div className='sm:mt-0 mt-10 flex flex-wrap justify-center gap-5 font-roboto'>
        {[1, 2, 3, 4].map((_, index) => (
          <div key={index} className='sm:w-[300px] w-[165px] sm:h-[150px] h-[160px] bg-gray-200 animate-pulse'>
      ...
      <div className='flex flex-col gap-3 mt-5'>
        <div className='text-[#0D0E4E] font-bold w-[150px] h-[20px] bg-gray-300 mb-2'></div>
